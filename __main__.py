...
from owrx.aircraft import AdsbParser
...
Support and info:       https://groups.io/g/openwebrx
    ...
    # Start a global ADS-B JSON parser independent of the selected profile.
    # The aircraft data is supplied by the remote dump1090 sync service.
    adsbParser = AdsbParser(
        service=True,
        jsonFile="/tmp/dump1090/aircraft.json"
    )
    ...
    # Stop the global ADS-B JSON parser.
    adsbParser.stop()
